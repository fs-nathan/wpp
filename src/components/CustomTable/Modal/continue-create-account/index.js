      ...
      <form id="form-create-multile-account" onSubmit={handleSubmit}>
        <div className="modal_continue-create_header">
          ...
          >
            ...
            />
            <Icon path={mdiUpload} size={1} color={"rgba(0, 0, 0, 0.54)"} />
        ...
        <div className="modal_continue-create_table">
              ...
              {rowTable &&
                rowTable.map((item, index) => (
                  <tr key={`${index}`}>
                    ...
                    <td>
                      <select onChange={handleOnchange("room", index)}>
                        {roomList &&
                          roomList.map((items, indexs) => (
                            <option key={indexs} value={items.id}>
                              {items.name}
                            </option>
                          ))}
                      </select>
          ...
          >
            ...
            />
            <div className="suggest-password" style={{ marginTop: "15px" }}>
