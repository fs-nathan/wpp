...
import { listScheduleOfWeekFail, listScheduleOfWeekSuccess } from '../../../actions/calendar/weeklyCalendar/listScheduleOfWeekFromModal';
...
function* listScheduleOfWeekFromModal(action) {
  try {
...
export { listScheduleOfWeekFromModal };
