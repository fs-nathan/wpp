...
function reducer(state = initialState, action) {
  switch (action.type) {
    case GROUP_SCHEDULE_DELETE_SHIFT_STAGE_ALLTIME:
      return {
        ...state,
        error: null,
        loading: action.quite ? false : true,
      };
    case GROUP_SCHEDULE_DELETE_SHIFT_STAGE_ALLTIME_SUCCESS:
      return {
        ...state,
        ...initialState,
        data: action.data,
    ...
    case GROUP_SCHEDULE_DELETE_SHIFT_STAGE_ALLTIME_FAIL:
      return {
        ...state,
        ...initialState,
        error: action.error,
