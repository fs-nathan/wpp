export const Routes = {
  ...
  SETTING_GROUP_ACCOUNT_INTERNAL: "/setting-group/account-internal",
  SETTING_GROUP_PAYMENT: "/setting-group/payment",
  CALENDAR: "/calendar",
  CALENDAR_WEEKLY: "/calendars/weekly/detail/:year/:schedule_id/:from?",
