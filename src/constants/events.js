...
export const UPLOAD_DOCUMENTS_USER = {
  SUCCESS: "EVENT_UPLOAD_DOCUMENTS_USER_SUCCESS",
  FAIL: "EVENT_UPLOAD_DOCUMENTS_USER_FAIL",
};
export const DELETE_DOCUMENTS_USER = {
  SUCCESS: "EVENT_DELETE_DOCUMENTS_USER_SUCCESS",
  FAIL: "EVENT_DELETE_DOCUMENTS_USER_FAIL",
};
...
export const UPDATE_GROUP_PERMISSION_USER = {
  SUCCESS: "EVENT_UPDATE_GROUP_PERMISSION_USER_SUCCESS",
  FAIL: "EVENT_UPDATE_GROUP_PERMISSION_USER_FAIL",
};
export const REMOVE_GROUP_PERMISSION_USER = {
  SUCCESS: "EVENT_REMOVE_GROUP_PERMISSION_USER_SUCCESS",
  FAIL: "EVENT_REMOVE_GROUP_PERMISSION_USER_FAIL",
};
...
export const RESEND_INVITATION_USER_JOIN_GROUP =
  "EVENT_RESEND_INVITATION_USER_JOIN_GROUP";
export const CANCLE_INVITATION_JOIN_GROUP =
  "EVENT_CANCLE_INVITATION_JOIN_GROUP";
export const ACCEPT_REQUIREMENT_USER_JOIN_GROUP =
  "EVENT_ACCEPT_REQUIREMENT_USER_JOIN_GROUP";
export const REJECT_REQUIREMENT_USER_JOIN_GROUP =
  "EVENT_REJECT_REQUIREMENT_USER_JOIN_GROUP";
...
export const LIST_PROJECT_GROUP_DELETED = {
  SUCCESS: "EVENT_LIST_PROJECT_GROUP_DELETED_SUCCESS",
  FAIL: "EVENT_LIST_PROJECT_GROUP_DELETED_FAIL",
};
...
export const KANBAN = {
  DETAIL_PROJECT: {
    SUCCESS: "EVENT_KANBAN_DETAIL_PROJECT_SUCCESS",
    FAIL: "EVENT_KANBAN_DETAIL_PROJECT_FAIL",
  },
  ADD_MANAGERS: {
    SUCCESS: "EVENT_KANBAN_ADD_MANAGERS_SUCCESS",
    FAIL: "EVENT_KANBAN_ADD_MANAGERS_FAIL",
  },
  REMOVE_MANAGERS: {
    SUCCESS: "EVENT_KANBAN_REMOVE_MANAGERS_SUCCESS",
    FAIL: "EVENT_KANBAN_REMOVE_MANAGERS_FAIL",
  },
  UPDATE_MANAGERS: {
    SUCCESS: "EVENT_KANBAN_UPDATE_MANAGERS_SUCCESS",
    FAIL: "EVENT_KANBAN_UPDATE_MANAGERS_FAIL",
  },
  DETAIL_TASK: {
    SUCCESS: "EVENT_KANBAN_DETAIL_TASK_SUCCESS",
    FAIL: "EVENT_KANBAN_DETAIL_TASK_FAIL",
  },
  UPDATE_TASK: {
    SUCCESS: "EVENT_KANBAN_UPDATE_TASK_SUCCESS",
    FAIL: "EVENT_KANBAN_UPDATE_TASK_FAIL",
  },
  LIST_TASK: {
    SUCCESS: "EVENT_KANBAN_LIST_TASK_SUCCESS",
    FAIL: "EVENT_KANBAN_LIST_TASK_FAIL",
  },
  SORT_TASK: {
    SUCCESS: "EVENT_KANBAN_SORT_TASK_SUCCESS",
    FAIL: "EVENT_KANBAN_SORT_TASK_FAIL",
  },
  SORT_GROUP_TASK: {
    SUCCESS: "EVENT_KANBAN_SORT_GROUP_TASK_SUCCESS",
    FAIL: "EVENT_KANBAN_SORT_GROUP_TASK_FAIL",
  },
  GET_MANAGER: {
    SUCCESS: "EVENT_KANBAN_GET_MANAGER_SUCCESS",
    FAIL: "EVENT_KANBAN_GET_MANAGER_FAIL",
  },
};
...
export const DELETE_TRASH_PROJECT_FAIL = "EVENT_DELETE_TRASH_PROJECT_FAIL";
...
export const REMOVE_GROUP_PERMISSION_MEMBER = {
  SUCCESS: "EVENT_REMOVE_GROUP_PERMISSION_MEMBER_SUCCESS",
  FAIL: "EVENT_REMOVE_GROUP_PERMISSION_MEMBER_FAIL",
};
...
export const UPDATE_NOTIFICATION_SETTING = {
  SUCCESS: "EVENT_UPDATE_NOTIFICATION_SETTING_SUCCESS",
  FAIL: "EVENT_UPDATE_NOTIFICATION_SETTING_FAIL",
};
export const UPDATE_PIN_BOARD_SETTING = {
  SUCCESS: "EVENT_UPDATE_PIN_BOARD_SETTING_SUCCESS",
  FAIL: "EVENT_UPDATE_PIN_BOARD_SETTING_FAIL",
};
...
export const WEEKLY_SCHEDULE_SETTING_START_DAY =
  "EVENT_WEEKLY_SCHEDULE_SETTING_START_DAY";
export const UPDATE_WEEKLY_SCHEDULE = "EVENT_UPDATE_WEEKLY_SCHEDULE";
export const UPDATE_WEEKLY_SCHEDULE_FROM_MODAL =
  "EVENT_UPDATE_WEEKLY_SCHEDULE_FROM_MODAL";
export const DELETE_WEEKLY_SCHEDULE = "EVENT_DELETE_WEEKLY_SCHEDULE";
export const DELETE_WEEKLY_SCHEDULE_FROM_MODAL =
  "EVENT_DELETE_WEEKLY_SCHEDULE_FROM_MODAL";
export const DELETE_ALL_WEEKLY_SCHEDULE = "EVENT_DELETE_ALL_WEEKLY_SCHEDULE";
export const CREATE_PROJECT_GROUP_SCHEDULE =
  "EVENT_CREATE_PROJECT_GROUP_SCHEDULE";
export const UPDATE_PROJECT_GROUP_SCHEDULE =
  "EVENT_UPDATE_PROJECT_GROUP_SCHEDULE";
export const DELETE_PROJECT_GROUP_SCHEDULE =
  "EVENT_DELETE_PROJECT_GROUP_SCHEDULE";
export const PROJECT_SCHEDULE_SETTING_START_DAY =
  "EVENT_PROJECT_SCHEDULE_SETTING_START_DAY";
export const PROJECT_SCHEDULE_ADD_WORKING_DAYS =
  "EVENT_PROJECT_SCHEDULE_ADD_WORKING_DAYS";
export const PROJECT_SCHEDULE_DELETE_WORKING_DAYS =
  "EVENT_PROJECT_SCHEDULE_DELETE_WORKING_DAYS";
export const PROJECT_SCHEDULE_ADD_DAY_OFF =
  "EVENT_PROJECT_SCHEDULE_ADD_DAY_OFF";
export const PROJECT_SCHEDULE_DELETE_DAY_OFF =
  "EVENT_PROJECT_SCHEDULE_DELETE_DAY_OFF";
export const CREATE_PERSONAL_REMIND_CATEGORY =
  "EVENT_CREATE_PERSONAL_REMIND_CATEGORY";
export const UPDATE_PERSONAL_REMIND_CATEGORY =
  "EVENT_UPDATE_PERSONAL_REMIND_CATEGORY";
export const SORT_PERSONAL_REMIND_CATEGORY =
  "EVENT_SORT_PERSONAL_REMIND_CATEGORY";
export const DELETE_PERSONAL_REMIND_CATEGORY =
  "EVENT_DELETE_PERSONAL_REMIND_CATEGORY";
...
export const PROJECT_SCHEDULE_SETTING_WORKING_DAY =
  "EVENT_PROJECT_SCHEDULE_SETTING_WORKING_DAY";
export const PROJECT_SCHEDULE_SETTING_STARTING_DAY =
  "EVENT_PROJECT_SCHEDULE_SETTING_STARTING_DAY";
export const PROJECT_SCHEDULE_CREATE_SHIFT_STAGE_ALLTIME =
  "EVENT_PROJECT_SCHEDULE_CREATE_SHIFT_STAGE_ALLTIME";
export const PROJECT_SCHEDULE_DELETE_SHIFT_STAGE_ALLTIME =
  "EVENT_PROJECT_SCHEDULE_DELETE_SHIFT_STAGE_ALLTIME";
export const PROJECT_SCHEDULE_UPDATE_SHIFT_STAGE_ALLTIME =
  "EVENT_PROJECT_SCHEDULE_UPDATE_SHIFT_STAGE_ALLTIME";
export const PROJECT_SCHEDULE_CREATE_WORKING_STAGE =
  "EVENT_PROJECT_SCHEDULE_CREATE_WORKING_STAGE";
export const PROJECT_SCHEDULE_UPDATE_WORKING_STAGE =
  "EVENT_PROJECT_SCHEDULE_UPDATE_WORKING_STAGE";
export const PROJECT_SCHEDULE_DELETE_WORKING_STAGE =
  "EVENT_PROJECT_SCHEDULE_DELETE_WORKING_STAGE";
export const PROJECT_SCHEDULE_CREATE_SHIFT_STAGE =
  "EVENT_PROJECT_SCHEDULE_CREATE_SHIFT_STAGE";
export const PROJECT_SCHEDULE_UPDATE_SHIFT_STAGE =
  "EVENT_PROJECT_SCHEDULE_CREATE_SHIFT_STAGE";
export const PROJECT_SCHEDULE_DELETE_SHIFT_STAGE =
  "EVENT_PROJECT_SCHEDULE_CREATE_SHIFT_STAGE";
export const INVITE_OTHER_PEOPLE_CREATE_ACCOUNT =
  "EVENT_INVITE_OTHER_PEOPLE_CREATE_ACCOUNT";
export const GET_REMIND_DETAIL_FAIL = "EVENT_GET_REMIND_DETAIL_FAIL";
export const RECENTLY_VIEW_PROJECTS_EMPTY_EVENT =
  "RECENTLY_VIEW_PROJECTS_EMPTY_EVENT";
export const CREATE_OFFER_GROUP_SUCCESS = "EVENT_CREATE_OFFER_GROUP_SUCCESS";
export const UPDATE_OFFER_GROUP_SUCCESS = "EVENT_UPDATE_OFFER_GROUP_SUCCESS";
export const DELETE_OFFER_GROUP_SUCCESS = "EVENT_DELETE_OFFER_GROUP_SUCCESS";
export const UPDATE_DURATION_TASK = "UPDATE_DURATION_TASK";
export const UPDATE_INFOMATION_TASK = "UPDATE_INFOMATION_TASK";
...
export const USE_TEMPLATE = {
  SUCCESS: "EVENT_USE_TEMPLATE_SUCCESS",
  FAIL: "EVENT_USE_TEMPLATE_FAIL",
};
