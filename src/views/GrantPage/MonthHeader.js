...
const MonthHeader = ({startTimeProject,allMonth, daysRender,scrollWidth,dataSource, leftHeader = 0}) => {
    ...
    const month = allMonth.map(item => <div style={{
        borderBottom: '1px solid #f0f0f0',
        borderTop: '1px solid #f0f0f0',
        padding: '2px 0px',
        borderRight: '1px solid #f0f0f0',backgroundColor: '#fafafa', width: item.width, textAlign: 'center'}}>
        {item.text}
    </div>)
    const day = daysRender.map((item, index) =><div style={{borderBottom: '1px solid #f0f0f0',
