...
const TimeLine = ({ startPosition, isTotalDuration, girdInstance, endPosition, index, setDataSource, dataSource, startDate, endDate, timelineColor, visibleGantt, isGroupTask }) => {
    ...
    if (isGroupTask && !visibleGantt.group)
        return null
    if (!isGroupTask && !isTotalDuration && !isTotalDuration && !visibleGantt.task)
        return null
        ...
        <React.Fragment>
            <div ref={totalTimeRef}
                ...
                <ResizableBox
                    ...
                    handle={() => (
                        ...
                        >
                            {!isGroupTask && !isTotalDuration && <Circle show={showResize} left={9} />}
                        </span>
                    )}
                ...
                >
                    ...
                    >
                        {!isGroupTask && !isTotalDuration && <Circle show={showResize} left={-15} />}
                    </div>
            ...
            <div
                ...
                style={{
                    ...
                    transform: 'translateY(-50%)',
                    position: 'absolute',
                    cursor: !isGroupTask && !isTotalDuration && !isTotalDuration ? 'move' : 'default',
                    ...b
                }}>
