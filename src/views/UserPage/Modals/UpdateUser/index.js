    ...
    <React.Fragment>
      ...
      >
        <StyledDialogTitle id="alert-dialog-slide-title">
          <ColorTypo uppercase>{_.get(updatedUser, 'name', '')}</ColorTypo>
        ...
        <DialogActions>
          <ColorButton onClick={handleUpdateUser} variant='text' variantColor='green'>
            {t("views.user_page.modals.update_user.ok_button")}
          </ColorButton>
        </DialogActions>
      </Dialog>
    </React.Fragment>
