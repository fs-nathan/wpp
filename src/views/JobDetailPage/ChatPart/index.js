...
function ChatPart(props) {
  ...
  function onClickSearch() {
    dispatch(
      loadChat(taskId, undefined, false, undefined, undefined, searchChatKey)
    );
  }
  ...
  return (
    <div
      className="container-chatpart chatPart"
      {...getRootProps({
    ...
    >
      ...
      {isShowSearch && (
        <div className="chatPart--searchWrap ">
          <div className="chatPart__showSearch">
            <SearchInput
              className="chatPart--search"
              onClickSearch={onClickSearch}
              placeholder={t("LABEL_CHAT_TASK_TIM_NOI_DUNG_TRONG_HOI_THAO")}
              value={searchChatKey}
      ...
      {pinnedRemind && (
        <div
          className={clsx("chatPart--pinRemind", {
            chatPart__showPinRemind: true,
          })}
        >
          <img
            className="chatPart--pinImage"
            src="/images/alarm-clock.png"
            alt="pin"
          ></img>
          <div className="chatPart--pinRight">
            <div className="chatPart--pinContent">{pinnedRemind.content}</div>
      ...
      {isDragActive && (
        <div className="drop-area">
          <div className="dashed-box">
            <div className="des-drop">
              {t("LABEL_CHAT_TASK_THA_FILE_VAO_DAY")}
            </div>
          </div>
        </div>
      )}
