...
const mapDispatchToProps = dispatch => {
  return {
    ...
    getSubTaskByTaskId: taskId =>
      dispatch(taskDetailAction.getSubTask({ taskId })),
    ...
    getRemindByTaskId: taskId =>
      dispatch(taskDetailAction.getRemind({ taskId })),
    ...
    // command
    getCommandByTaskId: task_id =>
      dispatch(taskDetailAction.getCommand({ task_id })),
    ...
    getFileByTaskId: taskId =>
      dispatch(taskDetailAction.getFileTabPart({ taskId })),
    getLinkByTaskId: taskId =>
      dispatch(taskDetailAction.getLinkTabPart({ taskId })),
    // Location
    ...
    // update Priority
    updateTaskPriority: (task_id, priority) =>
      dispatch(taskDetailAction.updatePriority({ task_id, priority })),
    // Member
    getMemberByTaskId: task_id =>
      dispatch(taskDetailAction.getMember({ task_id })),
    getMemberNotAssignedByTaskId: task_id =>
      dispatch(taskDetailAction.getMemberNotAssigned({ task_id })),
    ...
    //time
    getTrackingTime: task_id =>
      dispatch(taskDetailAction.getTrackingTime(task_id)),
    updateTimeDuration: dataTime =>
      dispatch(taskDetailAction.updateTimeDuration(dataTime)),
    // List Task Detail
    getListTaskDetailByProjectId: projectId =>
