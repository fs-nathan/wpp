...
import { DELETE_OFFER_SUCCESSFULLY, HANDLE_OFFER_OFFERPAGE, UPDATE_OFFER_DETAIL_DESCRIPTION_SECTION_SUCCESS, UPDATE_OFFER_SUCCESS } from "views/OfferPage/redux/types";
...
const Recently = () => {
  ...
  useEffect(() => {
    ...
    CustomEventListener(UPDATE_OFFER_SUCCESS, refreshRencentlyPage);
    return () => {
      ...
      CustomEventDispose(UPDATE_OFFER_SUCCESS, refreshRencentlyPage);
    }
  }, [dispatch]);
