...
export const loadOfferByGroupID = ({
  id,
  startDate,
  endDate
}) => {
...
export const loadOfferByDepartmentID = ({
  id,
  startDate,
  endDate
}) => {
...
export const loadSummaryOverview = ({
  timeRange
}) => {
  return {
...
export const updateOfferDetailDescriptionSection = ({
  offerId,
  title,
  content,
  offerGroupId,
...
export const getCommentListOfferDetail = ({
  offerId,
  additionQuery
}) => {
  return {
...
export const postCommentOfferDetail = ({
  offerId,
  content,
  additionQuery
}) => {
...
export const updateCommentOfferDetail = ({
  commentId,
  content,
  additionQuery
}) => {
...
export const removeCommentOfferDetail = ({
  commentId,
  additionQuery
}) => {
  return {
...
export const deleteDocumentOffer = ({
  offer_id,
  file_id,
  additionQuery
}) => {
...
export const deleteMemberHandle = ({
  offer_id,
  member_id,
  additionQuery
}) => {
...
export const deleteMemberMonitor = ({
  offer_id,
  member_id,
  additionQuery
}) => {
...
export const handleOfferOfferPage = ({
  offer_id,
  content,
  status,
  additionQuery
...
export const getMemberToAdd = ({ additionQuery }) => {
  return {
    type: OFFER_GET_MEMBER_TO_ADD,
    payload: { additionQuery }
  }
}