...
import { CustomEventDispose, CustomEventListener, KANBAN, CREATE_TASK, DELETE_TASK, CREATE_GROUP_TASK, COPY_GROUP_TASK } from 'constants/events';
...
function KanbanBoard({
  ...
  React.useEffect(() => {
    ...
    CustomEventListener(CREATE_GROUP_TASK, doKanbanListTaskHandler);
    CustomEventListener(COPY_GROUP_TASK, doKanbanListTaskHandler);
    return () => {
      ...
      CustomEventDispose(CREATE_GROUP_TASK, doKanbanListTaskHandler);
      CustomEventDispose(COPY_GROUP_TASK, doKanbanListTaskHandler);
    }
  }, [projectId]);
