...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    doCreateUserRole: ({ name, description }) =>
      dispatch(createUserRole({ name, description })),
    doUpdateUserRole: ({ userRoleId, name, description }) =>
      dispatch(updateUserRole({ userRoleId, name, description })),
  };
};

export default connect(null, mapDispatchToProps)(RoleCreateAndUpdate);
