...
const MyButton = ({
  ...
  <Button
    variant="outlined"
    className={`view_ProjectGroupPage_Table_Deleted___button${
      isDel ? "-delete" : ""
...
function DeletedProjectTable({
  ...
  const [title, setTitle] = React.useState(
    t("LABEL_ALL_DELETED_WORKING_BOARD")
  );
      ...
      <React.Fragment>
        <CustomTable
          options={{
            ...
            noData: {
              bool:
                projects.firstTime === false && projects.projects.length === 0,
            },
          }}
          columns={[
            {
            ...
            },
            {
              ...
              field: (row) => (
                <span style={{ fontSize: 14 }}>{get(row, "name")}</span>
              ),
            ...
            },
            {
              ...
              field: (row) => (
                <CustomBadge
                  ...
                  background={
                    decodePriorityCode(get(row, "priority_code", 0)).background
                  }
                >
                  ...
                  <MyButton
                    ...
                    disabled={
                      !isNil(
                        find(
                          concat(
                            pendings.deletePendings,
                            pendings.restorePendings
                          ),
...
export default connect(
  (state) => ({
    projectGroup: get(
      state.projectGroup.listProjectGroupDeleted.data,
      "projectGroups",
      []
    ),
  }),
