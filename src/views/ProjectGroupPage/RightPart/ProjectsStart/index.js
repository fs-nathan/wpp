...
function ProjectsStart({statusWorkGroup, getStatusWorkGroup}) {
  ...
  const [modalCreateGroupWorking, setModalCreateGroupWorking] = React.useState(false);
  ...
  return (
    <>
      ...
      <CreateProjectGroup open={modalCreateGroupWorking} setOpen={setModalCreateGroupWorking} />
      <ModalCreateAccount
      ...
      />
      <AddUserModal setOpen={setOpenAddUserModal} open={openAddUSerModal} reload={true} projectId={null}/>
