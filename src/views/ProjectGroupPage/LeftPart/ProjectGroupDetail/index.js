...
const mapDispatchToProps = (dispatch) => {
  return {
    doDeleteProjectGroup: ({ projectGroupId }) =>
      dispatch(deleteProjectGroup({ projectGroupId })),
...
export default connect(mapStateToProps, mapDispatchToProps)(ProjectGroupDetail);
