...
import {CustomEventDispose, CustomEventListener, RESTORE_TRASH_PROJECT} from "../../../../constants/events";

function ProjectListDeleted({
  groups, viewPermissions,
  ...
  return (
    <>
      <ProjectGroupListPresenter
        groups={newGroups}
        canModify={get(viewPermissions.permissions, 'manage_group_project', false)}
...
const mapDispatchToProps = dispatch => {
  return {
    doListProjectGroupDeleted: (quite) => dispatch(listProjectGroupDeleted(quite))
  }
}
